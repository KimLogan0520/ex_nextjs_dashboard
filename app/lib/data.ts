...
export async function fetchRevenue() {
  ...
  try {
    ...
    console.log('[TEST LOG / fetchRevenue()] Fetching revenue data...');
    await new Promise((resolve) => setTimeout(resolve, 3000));

    const data = await sql<Revenue>`SELECT * FROM revenue`;

    console.log('[TEST LOG / fetchRevenue()] Data fetch completed after 3 seconds.');
...
export async function fetchLatestInvoices() {
  ...
  try {
    console.log('[TEST LOG / fetchLatestInvoices()] Fetching Latest Invoices data...');
    ...
    console.log('[TEST LOG / fetchLatestInvoices()] Data fetch completed after 2 seconds.');
